...
int ops_snmp_send_trap(const struct ovsrec_snmp_trap *trap_row, netsnmp_session *session, netsnmp_session *ss,  netsnmp_pdu *pdu, netsnmp_pdu *response,int inform){
    int status = 0;

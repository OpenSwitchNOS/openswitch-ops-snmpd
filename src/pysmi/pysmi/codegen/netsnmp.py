...
"""
            ...
            tableFileString += tableName+'_ovsdb_idl_init(struct ovsdb_idl *idl);\n'
            tableFileString += '}\n\n'
...
"""
        ...
        for trap in self.notificationSymbols:
            ...
            notificationFileString += '\nint send_' + trap + '(struct ovsdb_idl* idl,'
            objectString = []
            for obj in trapSym['objects']:
            ...
            for obj in trapSym['objects']:
                ...
                notificationFileString += 'goto loop_cleanup;\n'
                notificationFileString += '}\n\n'
            notificationFileString += 'status = ops_snmp_send_trap(trap_row, &session,ss, pdu,response,inform);\n'
            notificationFileString += 'if(status < 0){\n'
